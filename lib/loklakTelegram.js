...
module.exports = function (bot, redisClient) {
  ...
  function noCommandFound(msg) {
    bot.sendMessage(msg.chat.id, "4️⃣0️⃣4️⃣! Sorry! We couldn't quite understand you. You can type /help for more information about the commands you can entered.", {
      reply_markup: {
        keyboard: [["/help"]],
        one_time_keyboard: true,
        resize_keyboard: true
